...
public partial class AfadBasvuruTekil
{
    ...
    public DateTime CsbOlusturmaTarihi { get; set; }

    public DateTime? CsbGuncellemeTarihi { get; set; }

    public bool? CsbAktifMi { get; set; }

    public bool CsbSilindiMi { get; set; }

    public Guid CsbId { get; set; }

    public DateOnly HedefTarih { get; set; }

    public long? CsbRezervAlanId { get; set; }
}
