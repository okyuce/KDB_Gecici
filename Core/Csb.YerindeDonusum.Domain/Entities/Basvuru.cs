...
public partial class Basvuru
{
    ...
    public DateTime? HuidKontrolTarihi { get; set; }

    public string? Huid { get; set; }

    public string? HasarTespitGuclendirmeMahkemeSonucu { get; set; }

    public virtual AydinlatmaMetni AydinlatmaMetni { get; set; } = null!;
    ...
    public virtual BasvuruIptalTur? BasvuruIptalTur { get; set; }

    public virtual BasvuruKanal BasvuruKanal { get; set; } = null!;

    public virtual ICollection<BasvuruTapuBilgi> BasvuruTapuBilgis { get; set; } = new List<BasvuruTapuBilgi>();
