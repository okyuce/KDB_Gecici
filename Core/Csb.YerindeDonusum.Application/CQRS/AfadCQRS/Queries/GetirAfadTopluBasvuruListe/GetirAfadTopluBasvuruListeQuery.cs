...
public class GetirAfadTopluBasvuruListeQuery : IRequest<ResultModel<AfadTotalCountResultModel<List<GetirAfadTopluBasvuruDto>>>>, ICacheMediatrQuery
{
    ...
    public class GetirAfadBasvuruListeTopluQueryHandler : IRequestHandler<GetirAfadTopluBasvuruListeQuery, ResultModel<AfadTotalCountResultModel<List<GetirAfadTopluBasvuruDto>>>>
    {
        ...
        public async Task<ResultModel<AfadTotalCountResultModel<List<GetirAfadTopluBasvuruDto>>>> Handle(GetirAfadTopluBasvuruListeQuery request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                using (HttpClient client = new HttpClient())
                {
                    ...
                    using (var clientResponse = await client.PostAsync($"{_afadOptionModel.BaseUrl}komisyon/hakSahipleri", postContent))
                    {
