...
namespace Csb.YerindeDonusum.Application.CQRS.BinaDegerlendirmeCQRS.Queries.KaydetPasifMalikKamuUstelenecek;

public class KaydetPasifMalikKamuUstelenecekCommandRequestModel
{
    ...
    public string? HibeOdemeTutar { get; set; }
    public string? KrediOdemeTutar { get; set; }
}