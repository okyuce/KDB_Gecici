...
{
    public class KdsHasarTespitVeriByAskiKoduHasarTespitVeriQuery : IRequest<ResultModel<KdsHaneModel>>
    {
        public string? AskiKodu { get; set; }

        public class KdsHasarTespitVeriByAskiKoduHasarTespitVeriQueryHandler : IRequestHandler<KdsHasarTespitVeriByAskiKoduHasarTespitVeriQuery, ResultModel<KdsHaneModel>>
        {
            ...
            public KdsHasarTespitVeriByAskiKoduHasarTespitVeriQueryHandler(IMapper mapper, IKdsHasartespitTespitVeriRepository kdsHasartespitTespitVeriRepository, IWebHostEnvironment webHostEnvironment, ICacheService cacheService, IIstisnaAskiKoduRepository istisnaAskiKoduRepository)
            {
                _mapper = mapper;
            ...
            public async Task<ResultModel<KdsHaneModel>> Handle(KdsHasarTespitVeriByAskiKoduHasarTespitVeriQuery request, CancellationToken cancellationToken)
            {
                var result = new ResultModel<KdsHaneModel>();

                request.AskiKodu = HasarTespitAddon.AskiKoduToUpper(request.AskiKodu);

                var cacheKey = $"{_webHostEnvironment.EnvironmentName}_" + $"{nameof(KdsHasarTespitVeriByAskiKoduHasarTespitVeriQuery)}_AskiKodu_{request.AskiKodu}";
                ...
                HasartespitTespitVeri? hasarTespitVeri = null;

                var queryHasarTespitVeriListe = _kdsHasartespitTespitVeriRepository
